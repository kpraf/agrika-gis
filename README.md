...
> **`report-1-scope` branch — Progress Report 1 build (Aug 31 – Sep 18, 2026).**
> This branch is scoped to the deliverables due by Sep 18 on the project timetable:
> **Module 1 — Home & System Information**, **Module 2 — Real-Time & Historical Yield
> Monitoring**, **Module 3 — Spatial GIS Visualization & Analysis**, and **Module 6 — User
> Access Management & System Configuration**, plus the backend **CNN-LSTM model features**
> (Objective 1) and the **automated data pipeline** (Objective 3). The **Analytics** (Module 4,
> Sep 22) and **Reports** (Module 5, Sep 24) modules are scheduled for the succeeding reports
> and are not part of this build. See the full-system feature list below for the complete
> planned scope.
